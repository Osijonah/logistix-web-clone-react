...
export const quicktourList = [{
    ...
    para: 'Your <span class="medium1">Customers can Track Their Parcels</span> from Pickup to Destination. They get an estimated delivery time for every parcel they ship using a Tracking ID that will be sent to their mail after registering their parcels.',
    img: tracker,
    alt: "tracker"
}, {
    header: "Receive & Manage Orders",
    para: 'We made it possible that You, as well as your Administrators can <span class="medium1">Manage Shipments And Monitor Parcels</span> from Pickup to Destination. You also have the ability to <span class="medium1">Manage your Customers’ information</span> so you can always be in communication with your customers.',
    img: orders,
    alt: "orders"
}, {
    ...
    para: 'We designed it with the ability to allow you <span class="medium1">Delegate Administrative Tasks</span> such as the management of shipments and dispatch riders to administrators so you can focus on growing your business.',
    img: administrators,
    alt: "administrators"
}]